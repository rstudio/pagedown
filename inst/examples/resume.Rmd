...
left-column:
  ...
  - title: Education
    ...
    - name: Beijing University of Chemical Technology
      place: B.S. in Information and Computing Sciences
      location: Beijing, China
      to: 2010
      #content: >
      #  Thesis: Dyadic wavelet and its application in edge detection
    - name: University of Chinese Academy of Sciences
      place: M.S. in Bioinformatics
      location: Beijing, China
      to: 2014
      #content: 
  ...
  - title: Research Experience
    ...
    - name: Graduate Research Assistant
      place: Beijing Institute of Genomics, Chinese Academy of Sciences
      location: Beijing, China
      from: 2011
      to: 2014
      content: |
    ...
    - name: Bioinformatican
      place: My Health Gene Technology Co., Ltd.
      location: Beijing, China
      from: 2015
      to: 2016
      content: |
  ...
  - title: Professional Experience
    ...
    - name: Data Scientist, intern
      ...
      to: 2014
      content: |
        - Taught R language for beginners. 
    ...
    - name: Bioinformatician
      ...
      content: |
        ...
        - Studied tumor metastasis and wrote research report. 
  ...
  - title: Teaching Experience
    ...
    items:
      - name: Introduction to R Language for Beginners.
        place: Instructor of R and Data Mining Training Courses at SupStat Inc.
        location: Beijing, China
        to: 2014
      - name: Computational Biology and Bioinformatics.
        place: Teaching assistant of GBS CB2-201 courses at UAB
        location: AL, USA
        from: 2016
        to: 2017
  ...
  - title: Selected Publications and Posters
    ...
    items:
      - name: Genetic and epigenetic signals are found predictive to the distribution of intra-individual divergence of alternative splicing.
        place: Poster for 2013 International Conference of Genomics
      ...
      - name: ESCRT-0 complex modulates Rbf mutant cell survival by regulating Rhomboid endosomal trafficking and EGFR signaling.
        place: J Cell Sci. 2016 May 15;129(10):2075-84.
        to: 2016 
        content: |
