...
To learn more about paged.js and CSS for Paged Media, you may check out [the cheatsheet of paged.js](https://www.pagedjs.org/documentation/cheatsheet/).
...
Note that it is possible to use Sass (including a file with `.sass` or `.scss` extension in the `css` option). Moreover, this overriding mechanism also works for other output formats in **pagedown**.
