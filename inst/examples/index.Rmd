...
HTMLWidgets keep their interactivity: you can insert a widget, interactively modify it and then print the document.^[This interactivity is not allowed in RStudio because of security restrictions.] As any other figures, you can modify their dimensions and styles using the chunk options `out.width`, `out.height` and `out.extra`.  
